 ...
 * @author justinhess
 */
public class GetRequirementsRequestObserverFacade implements RequestObserver {
	
	private GetRequirementsControllerFacade controller;
	
	/**
	 * Constructs the observer given a GetRequirementsController
	 * @param controller the controller used to retrieve requirements
	 */
	public GetRequirementsRequestObserverFacade(GetRequirementsControllerFacade controller) {
