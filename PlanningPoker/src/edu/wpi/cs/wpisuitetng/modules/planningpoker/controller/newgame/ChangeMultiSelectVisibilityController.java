 ...
 * @version 1.0
 */
public class ChangeMultiSelectVisibilityController implements ActionListener {
	 ...
	 */
	public ChangeMultiSelectVisibilityController(CreateGameInfoPanel createGameInfoPanel) {
	...
	public void actionPerformed(ActionEvent event) {
		view.enableOrDisableMultiSelect();
	}
